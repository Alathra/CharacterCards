package io.github.alathra.charactercards.hook.placeholderapi;

import io.github.alathra.charactercards.CharacterCards;
import io.github.alathra.charactercards.hook.AbstractHook;
import io.github.alathra.charactercards.hook.Hook;
...
public class PAPIHook extends AbstractHook {
     ...
     */
    public PAPIHook(CharacterCards plugin) {
        super(plugin);
    }
